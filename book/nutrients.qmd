...
<!--XXX. Unclear what "larges" and "second-largest" pool refers to. Reactive N? Plant-available N? Total N. This should be backed up by a visualisation of the pool sizes, ideally distinguishing chemical form (N2, dissolved, mineral, gaseous reactive forms,...) -->
...
**Atmosphere**: Nitrogen gas (N~2~) makes up 78% of the atmosphere content.  Despite constituting an enormous pool, N~2~ is not accessible to most of terrestrial organisms [@myrold1999].

**Lithosphere**: In the upper lithosphere, nitrogen is found in silicate minerals (e.g., clay minerals, mica, feldspar) in the form of NH~4~^+^ [@mysen2019]. This pool is generally not directly accessible to organisms due to strong bonds, but nitrogen stored in minerals can be released to the soil as part of the weathering process.

**Biosphere**: Nitrogen is present in tissues of organisms, proteins, amino acids, and nucleic acids. Typical carbon-to-nitrogen stoichiometries in plant material and microbes can be found in Table 1.

**Pedosphere**: Soils constitute a large pool of nitrogen [@myrold1999], consisting of both inorganic (e.g., NO~3~^-^) and organic nitrogen (e.g., nitrogen found in soil organic matter). Of the different nitrogen components found in soils, ammonium (NH~4~^+^) and nitrate (NO~3~^-^) are available forms for uptake by plants.

<!-- XXX Please change all citations from for example '(@lacroix23)' to '[@lacroix23]'. Square, not round bracket! -->
...
<!-- XXX References to figures should use dyanamic cross-reference identifiers. Within the code chunk, set for example '#| label: fig-nitrogencycle', and then in the text '... this is shown in @fig-nitrogencycle'. -->
...
<!-- XXX dynamic cross reference 'Table 2' -->
