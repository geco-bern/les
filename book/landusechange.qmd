...
By comparing estimates for current actual vegetation C stocks with C stocks under potential natural vegetation (@sec-luc_methods), total land use change-induced C loss has been estimated at 447 PgC [@erb18nat]. This can be understood as being equal to the cumulative sum of related emissions since the advent of agriculture (@sec-hololu). During the industrial period (1750-2023), cumulative emissions from land use change are estimated at 255 $\pm$ 75 PgC (@tbl-gcb), which corresponds to around 34% of total industrial-era anthropogenic CO~2~ emissions, including emissions from fossil fuels.
