...
df <- read_csv(here("data/Global_Carbon_Budget_2023v1.1_tabHistoricalBudget.csv"))
...
df |> 
  ...
  scale_color_manual(
    ...
    labels = "Difference between residual \nsink minus simulated land sink"
    ) +
  theme_minimal() +
  theme(
