...
where $\chi = c_i/c_a$. The instantaneous water-use efficiency is proportional to $D^{-1}$. In other words, the drier the air, the more transpiration per unit net CO~2~ assimilation a leaf "suffers". This demonstrates the strong effect of atmospheric dryness on the water-carbon trade-off. To remove the effect of vapour pressure deficit ($D$) on transpiration and focus on the biological component of the water-carbon trade-off, the *intrinsic water-use efficiency* is defined by relating net assimilation to stomatal conductance: 
$$
