...
Spring phenology also drives increases in *latent heat flux* (moist air), and decreases in *sensible heat flux* (dry air) and therefore in the *Bowen ratio* (the ratio of sensible to latent heat). As a result, the increased transpiration cools and moistens the air, as has been observed in temperate and boreal deciduous forests [@barr2007gcc].
