...
During the soil N cycle (see @sec-nitrogen), N2O emissions can be produced during two distinct processes. Firstly, it can be produced during nitrification as a secondary product: 
