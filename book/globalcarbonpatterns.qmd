...
**Plant-soil interactions**  via fungi and bacteria strongly influence C and nutrient cycling in soils. Inputs of fresh litter and labile C through root exudates can lead to the decomposition  (*priming*) of stable, old C in the soil. These relationships are complex and implications for the global distribution of soil C is not clear.

The very high soil C density at high northern latitudes reflects also the particular functioning and soil C dynamics in peatland (@sec-peatlands) and permafrost (@sec-permafrost) regions. Taken together, the global distribution of soil C deviates strongly but not entirely from the distribution of GPP and biomass C. The parallel trends of average biomass and soil C along latitudes is shown in @fig-soilc_vegc_bylat.
